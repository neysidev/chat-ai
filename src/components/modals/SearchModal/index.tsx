    ...
    >
      <div className="fixed inset-0 w-screen overflow-y-auto p-2">
        <div className="flex min-h-full items-center justify-center">
          <DialogPanel
            transition
            className="sm:min-w-[500px] divide-y dark:divide-neutral-800 bg-white dark:bg-neutral-900 rounded-xl duration-300 ease-out data-[closed]:scale-95 data-[closed]:opacity-0"
          >
            <header className="px-5 py-4 flex items-center justify-between">
              ...
              />
              <CloseButton className="p-2 rounded-full transition hover:bg-neutral-200 dark:hover:bg-neutral-800">
            ...
            <div className="px-3 py-4 text-sm space-y-2">
              <button
                ...
                className="flex items-center font-medium text-neutral-600 dark:text-neutral-400 w-full space-x-2 p-2 transition rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-800"
              >
              ...
              <div className="space-y-2 font-medium">
                ...
                <button className="flex items-center w-full text-neutral-600 dark:text-neutral-400 space-x-2 p-2 transition rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-800">

  ...
  return (
    <ul className="divide-y">
      <li className="py-3 pt-0 space-x-8 flex items-center justify-between">
        ...
        <div className="flex">
          <div className="border-r pr-2 mr-2">
            <button className="px-3 py-1.5 flex items-center space-x-1 rounded-full transition hover:bg-neutral-100">
              <Icon name="play" size={14} />
              <span>Play</span>
            </button>
          </div>
          <button className="px-3 flex py-1.5 items-center space-x-1 rounded-full transition hover:bg-neutral-100">
            <span>Sol</span>
      ...
      <li className="py-3 space-y-2">
        ...
        <p className="text-xs pr-4 text-neutral-600">
